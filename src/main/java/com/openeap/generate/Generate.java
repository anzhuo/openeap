...
import com.openeap.common.utils.FileUtils;
import com.openeap.common.utils.FreeMarkers;
...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String packageName = "com.openeap.modules";
		...
		String templatePath = classPath.replace(separator+"webapp"+separator+"WEB-INF"+separator+"classes",
				separator+"java"+separator+"com"+separator+"openeap"+separator+"modules");
